            ...
            <div className="row g-0 mx-lg-0" >
                <div className="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s" >
                    <div className="p-lg-5 ps-lg-0" >
                        ...
                        <p className="text-white mb-4 pb-2">At that time, he was alone again. Pain is pain itself. Even so, the pain of life is their own. Clita was himself and he lived and sat, but still, life was full of pleasure just right.</p>
                ...
                <div className="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style={{minHeight:"400px"}}>
                    <div className="position-relative h-100"  data-aos="zoom-in-up">
                        <img className="position-absolute img-fluid w-100 h-100" src={whyus} style={{objectFit:"cover"}}  alt=""/>
                    </div>
                </div>
            </div>
        </div>
